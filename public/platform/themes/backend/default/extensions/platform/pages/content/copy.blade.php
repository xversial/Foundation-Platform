...
<!-- Page Title -->
@section('title')
	{{ Lang::line('platform/pages::general.content.title') }}
@endsection
...
<section id="pages-content">
	...
	<header class="navbar">
		<div class="navbar-inner">
			...
			<a class="brand" href="#">{{ Lang::line('platform/pages::general.content.title') }}</a>
	...
	<div class="quaternary page">
		@widget('platform/pages::admin.content.form.copy', $id)
	</div>
