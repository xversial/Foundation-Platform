<form action="{{ URL::to_admin('users/edit/' . $user['id']) }}" id="edit-form" class="form-horizontal" method="POST" accept-char="UTF-8">
    <input type="hidden" name="{{ Session::csrf_token }}" value="{{ Session::token() }}">
    
    <fieldset>
        <legend>Updating {{ $user['metadata']['first_name'] . ' ' . $user['metadata']['last_name'] }}</legend>
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <div class="input-append">
                    <input type="text" name="first_name" id="first_name" value="{{ Input::old('metadata.first_name', $user['metadata']['first_name']); }}" placeholder="{{ Lang::line('platform/users::form.users.create.first_name') }}" required>
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <div class="input-append">
                    <input type="text" name="last_name" id="last_name" value="{{ Input::old('metadata.last_name', $user['metadata']['last_name']); }}" placeholder="{{ Lang::line('platform/users::form.users.create.last_name') }}" required>
                    <span class="add-on"><i class="icon-user"></i></span>
                </div>
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <div class="input-append">
                    <input type="email" name="email" id="email" value="{{ Input::old('email', $user['email']); }}" placeholder="{{ Lang::line('platform/users::form.users.create.email') }}" required>
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <div class="input-append">
                    <input type="password" name="password" id="password" placeholder="{{ Lang::line('platform/users::form.users.create.password') }}">
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <div class="input-append">
                    <input type="password" name="password_confirmation" id="" placeholder="{{ Lang::line('platform/users::form.users.create.password_confirm') }}">
                    <span class="add-on"><i class="icon-key"></i></span>
                </div>
