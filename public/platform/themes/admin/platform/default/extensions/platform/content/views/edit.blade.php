	...
	<div class="control-group">
		...
		<div class="controls">
			<select name="status" id="status" required>
				<option value="1"{{ (Input::old('status', $content->status) === 1 ? ' selected="selected"' : '') }}>Enabled</option>
				<option value="0"{{ (Input::old('status', $content->status) === 0 ? ' selected="selected"' : '') }}>Disabled</option>
			</select>
