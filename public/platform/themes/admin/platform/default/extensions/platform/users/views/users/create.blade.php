...
<form class="form-horizontal" action="{{ Request::fullUrl() }}" method="POST" accept-char="UTF-8" autocomplete="off">
	...
	<fieldset>
		<legend>{{ Lang::get('platform/users::users/form.edit.legend') }}</legend>
		...
		<div class="control-group">
			...
			<div class="controls">
				<div class="input-append">
					<input type="text" name="first_name" id="first_name" value="{{ Input::old('first_name') }}" placeholder="{{ Lang::get('platform/users::users/form.first_name') }}" required>
		...
		<div class="control-group">
			...
			<div class="controls">
				<div class="input-append">
					<input type="text" name="last_name" id="last_name" value="{{ Input::old('last_name') }}" placeholder="{{ Lang::get('platform/users::users/form.last_name') }}" required>
					<span class="add-on"><i class="icon-user"></i></span>
				</div>
		...
		<div class="control-group">
			...
			<div class="controls">
				<div class="input-append">
					<input type="email" name="email" id="email" value="{{ Input::old('email') }}" placeholder="{{ Lang::get('platform/users::users/form.email') }}" required>
		...
		<div class="control-group">
			...
			<div class="controls">
				<div class="input-append">
					<input type="password" name="password" id="password" value="{{ Input::old('password') }}" placeholder="{{ Lang::get('platform/users::users/form.password') }}" required>
		...
		<div class="control-group">
			...
			<div class="controls">
				<div class="input-append">
					<input type="password" name="password_confirmation" id="password_confirmation" value="{{ Input::old('password_confirmation') }}" placeholder="{{ Lang::get('platform/users::users/form.password_confirm') }}" required>
					<span class="add-on"><i class="icon-key"></i></span>
				</div>
