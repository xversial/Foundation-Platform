...
<form class="form-horizontal" action="{{ Request::fullUrl() }}" method="POST" accept-char="UTF-8">
	...
	<div class="control-group">
		...
		<div class="controls">
			<input type="text" name="name" id="name" value="{{ Input::old('name'); }}" placeholder="{{ Lang::get('platform/content::form.name') }}">
	...
	<div class="control-group">
		...
		<div class="controls">
			<input type="text" name="slug" id="slug" value="{{ Input::old('slug'); }}" placeholder="{{ Lang::get('platform/content::form.slug') }}">
	...
	<div class="control-group">
		...
		<div class="controls">
			<textarea rows="10" name="value" id="value" placeholder="value" required>{{ Input::old('value') }}</textarea>
