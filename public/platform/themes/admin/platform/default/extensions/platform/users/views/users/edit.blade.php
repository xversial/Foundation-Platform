	...
	<ul class="nav nav-tabs">
 	...
 	<div class="tab-content">
		...
		<div class="tab-pane" id="tab-permissions">
 			@foreach ($permissions as $extension => $permissions)
			<fieldset>
					...
					@foreach ($permissions as $permission)
						<div class="controls">
							<label class="checkbox">
								...
								<input type="checkbox" name="permissions[{{ $permission['permission'] }}]" value="1"{{ (array_key_exists($permission['permission'], $userPermissions) ? ' checked="checked"' : '')}} />
								{{ $permission['label'] }}
							</label>
						</div>
					@endforeach
