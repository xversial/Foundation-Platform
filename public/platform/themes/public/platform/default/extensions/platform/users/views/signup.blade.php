...
<form id="signup-form" class="form-horizontal" method="POST" accept-char="UTF-8" autocomplete="off">
	...
	<fieldset>
		...
		<div class="control-group{{ $errors->has('email') ? ' error' : '' }}">
			<label class="control-label" for="email">{{ Lang::get('platform/users::auth/form.signup.email') }}:</label>
			<div class="controls">
				<div class="input-append">
					<input type="email" name="email" id="email" value="{{ Input::old('email') }}" placeholder="{{ Lang::get('platform/users::auth/form.signup.email_help') }}" requiredx>
		...
		<div class="control-group{{ $errors->has('email_confirmation') ? ' error' : '' }}">
			...
			<div class="controls">
				<div class="input-append">
					<input type="email" name="email_confirmation" id="email_confirmation" value="{{ Input::old('email_confirmation') }}" placeholder="{{ Lang::get('platform/users::auth/form.signup.email_confirm_help') }}" requiredx>
					<span class="add-on"><i class="icon-envelope"></i></span>
				</div>
		...
		<div class="control-group{{ $errors->has('password') ? ' error' : '' }}">
			<label class="control-label" for="password">{{ Lang::get('platform/users::auth/form.signup.password') }}:</label>
			<div class="controls">
				<div class="input-append">
		...
		<div class="control-group{{ $errors->has('password_confirmation') ? ' error' : '' }}">
			<label class="control-label" for="password_confirmation">{{ Lang::get('platform/users::auth/form.signup.password_confirm') }}:</label>
			<div class="controls">
				<div class="input-append">
