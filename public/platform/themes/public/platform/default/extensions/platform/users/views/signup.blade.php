...
<form id="signup-form" class="form-horizontal" method="POST" accept-char="UTF-8" autocomplete="off">
	...
	<fieldset>
		...
		<div class="control-group{{ $errors->has('email_confirmation') ? ' error' : '' }}">
			...
			<div class="controls">
				<div class="input-append">
					<input type="email" name="email_confirmation" id="email_confirmation" value="{{ Input::old('email_confirmation') }}" placeholder="{{ Lang::get('platform/users::auth/form.email_confirm_help') }}" requiredx>
					<span class="add-on"><i class="icon-envelope"></i></span>
				</div>
		...
		<div class="control-group{{ $errors->has('password') ? ' error' : '' }}">
			...
			<div class="controls">
				<div class="input-append">
					<input type="password" name="password" id="password" placeholder="{{ Lang::get('platform/users::auth/form.password_help') }}" requiredx>
		...
		<div class="control-group{{ $errors->has('password_confirmation') ? ' error' : '' }}">
			...
			<div class="controls">
				<div class="input-append">
					<input type="password" name="password_confirmation" id="password_confirmation" placeholder="{{ Lang::get('platform/users::auth/form.password_confirm_help') }}" requiredx>
					<span class="add-on"><i class="icon-key"></i></span>
				</div>
